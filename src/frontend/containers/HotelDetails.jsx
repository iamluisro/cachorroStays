    ...
    <Layout>
      <div className='hotel_details'>
        <div className='hotel__details__container'>
          ...
          <div className='hotel_address'>Sto Tomas Ajusco Km 28 1/2 Picacho Ajusco Tlalpan, Mexico</div>
          <div className='hotel__description'>
            <h1 className='hotel__subtitle'>Descripción</h1>
            <p className='hotel__description--description'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&aposs standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
            <div className='hotel__additional__services'>
              ...
              <div className='hotel__social__media'>
                <h1 className='hotel__subtitle'>Redes Sociales de este hotel</h1>
